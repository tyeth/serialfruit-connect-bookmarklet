(function() {
    ...
    link.rel = "stylesheet";
    link.href = "https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.28/src/style.css";
    document.head.appendChild(link);
    console.log('CSS loaded');

    // Create a script element for the JavaScript
    var script = document.createElement("script");
    script.src = "https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.28/src/script.js";
    script.onload = function() {
        ...
        fetch("https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.28/src/index.html")
