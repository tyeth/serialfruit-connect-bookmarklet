(function() {
    ...
    style.textContent = "@import url('https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.96/src/style.css');";
    ...
    script.src = "https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.96/src/script.js";
    script.onload = function() {
        ...
        fetch("https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.96/src/index.html")
