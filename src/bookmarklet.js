(function() {
    ...
    style.textContent = "@import url('https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.95/src/style.css');";
    ...
    script.src = "https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.95/src/script.js";
    script.onload = function() {
        ...
        fetch("https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.95/src/index.html")
