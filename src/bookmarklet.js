(function() {
    ...
    style.textContent = "@import url('https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.97/src/style.css');";
    ...
    script.src = "https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.97/src/script.js";
    script.onload = function() {
        ...
        fetch("https://cdn.jsdelivr.net/gh/tyeth/serialfruit-connect@v0.0.97/src/index.html")
